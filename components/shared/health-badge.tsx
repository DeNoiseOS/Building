...
const STYLES: Record<ProjectHealth, { label: string; className: string; dot: string }> = {
  healthy: {
    label: "On Track",
    className:
  ...
  watch: {
    label: "Watch",
    className: "bg-amber-400/10 text-amber-300 border-amber-400/25 backdrop-blur-md",
    dot: "bg-amber-400 shadow-[0_0_8px_oklch(0.78_0.16_80_/_0.7)]",
  },
  at_risk: {
    label: "At Risk",
    className: "bg-red-400/10 text-red-300 border-red-400/25 backdrop-blur-md",
